...
interface ResearchAcademicsProps {
  user: AppUser | null;
  onNavigate?: (section: string) => void;
}

export default function ResearchAcademics({ user, onNavigate }: ResearchAcademicsProps) {
  ...
  return (
    <div className="research-academics-dashboard">
      {/* Header Section */}
      ...
      <div className="research-content-grid">
        {/* Left Column */}
        <div className="research-left-column">
          {/* Recent Publications */}
        ...
        {/* Right Column */}
        <div className="research-right-column">
          {/* Quick Actions */}
          <div className="research-section">
            <div className="section-header">
              <h2 className="section-title">
